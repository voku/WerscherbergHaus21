...
const LYRICS = [
  ...
  { time: 16, text: "am Morgen man den Therapieplan erblickt,\nder Schreiner das Internet wieder flickt." },
  { time: 24, text: "Hier wohnen keine Diagnosen.\nHier wohnen Geschichten." },
  ...
  { time: 48, text: "Nicht weil er musste.\nNicht aus Pflicht." },
  { time: 54, text: "Sondern weil sein Herz es spricht." },
  { time: 60, text: "Familie wächst nicht nur im Blut,\nsie wächst im Mut." },
  { time: 68, text: "Und im Ja, das einer wagt,\nnoch mehr im Tun, das mehr als Worte sagt." },
  { time: 78, text: "Im nächsten Zimmer dann\nträgt man mehr als Koffer ran," },
  { time: 86, text: "mehr als Taschen, mehr als Zeit,\nsie tragen Hoffnung, Pflicht und Vergangenheit." },
  ...
  { time: 112, text: "Eine Tür weiter, Schritt für Schritt,\nrichtet jemand den Blick." },
  { time: 120, text: "Nicht laut, nicht inszeniert,\naber innerlich neu justiert." },
  { time: 128, text: "Man kann sich selbst ganz leise verlieren,\nzwischen Müssen und Funktionieren." },
  { time: 136, text: "Und findet zurück, ganz ohne Plan,\nam Küchentisch irgendwann." },
  { time: 144, text: "So wie die Tochter,\ndie macht, was sie macht." },
  { time: 152, text: "Das nächste Kind rennt, als wäre es leicht,\nals hätte Angst sie nie ganz erreicht." },
  { time: 160, text: "Vor Jahren stand ein Wort im Raum,\ndas keiner will, in keinem Traum." },
  { time: 168, text: "Doch heute trägt sie Kleid und Glanz,\nals Anna beim Karnevalstanz." },
  { time: 176, text: "Ihre Eltern teilen sich die Rehazeit\nund stehen beide für die Tochter bereit." },
  { time: 186, text: "Unsere Tochter lernt mehr, als Laute sagen,\nstellt ihre Fragen ohne Fragen." },
  { time: 194, text: "Und wenn wir wieder heimwärts fahren,\nbleibt etwas da aus diesen Tagen:" },
